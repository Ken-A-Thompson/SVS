...
Ns = [10**4] #number of haploid individuals (positive integer >=1)
u = 10**(-3) #mutation probability per generation per genome (0<=u<=1)
sigmas = [10**(-2)] #strength of selection (positive real number)
alpha = 10**(-1) #mutational sd in each trait dimension (positive real number)
