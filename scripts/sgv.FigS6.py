					...
					while rep < nreps:
						...
						while gen < maxgen + 1:
							...
							if gen % gen_rec == 0:
								...
								#print an update
								print('n=%d, opt1=%r, opt2=%r, rep=%d, gen=%d, n_muts=%d, segregation varance=%.3f, distance=%.3f, selection=%r' %(n, theta1, theta2, rep+1, gen, n_muts, segvar, opt_dists[j], ['parallel','divergent'][k])) 
